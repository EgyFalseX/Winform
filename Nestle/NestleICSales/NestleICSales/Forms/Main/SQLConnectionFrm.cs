...
namespace NestleICSales.Forms
{
    public partial class SQLConnectionFrm : Form
    {
        ...
        {
            MessageBox.Show("Funtion Stoped", "Stoped", MessageBoxButtons.OK, MessageBoxIcon.Information);
            return false;
        ...
        private void BtnDBPath_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (System.IO.File.Exists(fbd.SelectedPath + @"\Nestle.mdf") || System.IO.File.Exists(fbd.SelectedPath + @"\Nestle_log.mdf"))
                    {
        ...
        private void btnstart_Click(object sender, EventArgs e)
        {
            ...
            else if (RBCreate.Checked)
            {
                ...
                if (GenerateDatabase(FullConString, DBGenerateScript))
                    FullConString += ";Initial Catalog=Nestle";
                else
                    return;
            }
            else
