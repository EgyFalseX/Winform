    ...
    Private Sub RefreshList()
        ...
        If ErrorProvider = Nothing Then
            If FunLib.AllConsultanats Is Nothing Then
                MsgBox_("No Disactivated Consultanats found", 71, 23, False, Me)
                Me.Close()
    ...
    Private Sub BtnActivate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnActivate.Click
        If MsgBox("Are you sure ?", MsgBoxStyle.YesNo, "WARNING") = MsgBoxResult.Yes Then
            If LBCon.SelectedIndex <> -1 Then
                ...
                MsgBox_("Consultants activated", 113, 23, True, Me)
                RefreshList()
            End If
        End If
    End Sub
            ...
            If LBCon.SelectedIndex <> -1 Then
                ...
                Select Case ErrorProvider
                    Case Nothing
                        ...
                        MsgBox_("Can't delete consultant", 107, 23, False, Me)
                    Case "1"
                        ...
                        If System.IO.File.Exists(FunLib.AllConsultanats(LBCon.SelectedIndex).ConsCVPath) Then
                            ...
                            End Try
                        End If
                        MsgBox_("consultant is deleted", 115, 23, True, Me)
                        RefreshList()
                    Case Else
                        'Sql error
                        MsgBox_(ErrorProvider, 0, 20, False, Me)
