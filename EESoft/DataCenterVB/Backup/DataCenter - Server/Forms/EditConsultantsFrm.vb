Public Class EditConsultantsFrm
    ...
    Private Sub ReloadConsultants()
        ...
        ElseIf FunLib.AllConsultanats IsNot Nothing Then
            ...
            Next
        Else
            MsgBox_("No Consultants found", 111, 23, False, Me)
            Me.Close()
        End If
    End Sub
        ...
        If CBCon.SelectedIndex <> -1 And TxtName.Text.Trim.Length > 0 Then
            ...
            If ErrorProvider = Nothing Then
                ...
                Else
                    If NewPath = "" Then
                        FunLib.AllConsultanats(CBCon.SelectedIndex).ConsCVPath = ""
                        MsgBox("CV didn't save", MsgBoxStyle.Critical)
                        ResetForm()
                        ReloadConsultants()
                    Else
                ...
                MsgBox_("Consultant update complate", 90, 23, True, Me)
            Else
    ...
    Private Sub BtnDeactivate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDeactivate.Click
        If MsgBox("Are you sure ?", MsgBoxStyle.YesNo, "WARNING") = MsgBoxResult.Yes Then
            If CBCon.SelectedIndex <> -1 Then
                ...
                If ErrorProvider = Nothing Then
                    ResetForm()
                    MsgBox_("Consultant Deactivated", 106, 23, True, Me)
                    ReloadConsultants()
                Else
                    MsgBox_("Can't Deactivate Consultant", 0, 23, False, Me)
                End If
            End If
        End If
    End Sub
