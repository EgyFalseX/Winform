    ...
    Private Sub RefreshList()
        ...
        If ErrorProvider = Nothing Then
            If FunLib.AllUsers Is Nothing Then
                MsgBox_("No Disactivated users found", 90, 23, False, Me)
                Me.Close()
            Else
    ...
    Private Sub BtnActivate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnActivate.Click
        If MsgBox("Are you sure ?", MsgBoxStyle.YesNo, "WARNING") = MsgBoxResult.Yes Then
            If LBUsers.SelectedIndex <> -1 Then
                ...
                RefreshList()
                MsgBox_("User activated", 134, 23, True, Me)
            End If
        End If
    End Sub
            ...
            If LBUsers.SelectedIndex <> -1 Then
                ...
                Select Case ErrorProvider
                    Case Nothing
                        ...
                        MsgBox_("Can't delete user", 126, 23, False, Me)
                    Case "1"
                        'User deleted
                        MsgBox_("User is deleted", 133, 23, True, Me)
                        RefreshList()
                    Case Else
                        'Sql error
                        MsgBox_(ErrorProvider, 0, 20, False, Me)
