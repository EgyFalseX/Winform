...
Public Class LockedFilesFrm
    ...
    Private LockedFiles(-1) As FunctionLib.DataCenterClientLib.LockedFilesSTR
    ...
    Private Sub LockedFilesFrm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LVFiles.Items.Clear()
        ErrorproviderZ = FunLib.GetAllLockedFileByUser(FunLib.CUser.UID, LockedFiles)
        If ErrorproviderZ = Nothing Then
            If LockedFiles.Length > 0 Then
                ...
                Next
            Else
                MsgBox_("No locked files found", 114, 23, False, Me)
                Me.Close()
            End If
        Else
    ...
    Private Sub BtnApply_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnApply.Click
        ...
        For ForInt = 0 To LVFiles.CheckedItems.Count - 1
            ...
            End If
        Next
        MsgBox_("File(s) unlocked", 131, 23, True, Me)
        ReDim LockedFiles(-1)
        ErrorproviderZ = Nothing
    ...
    Private Sub CBSelectNone_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBSelectNone.CheckedChanged
        ...
        End If
    End Sub
    Private Sub LockedFilesFrm_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        If ReloadFiles = True Then
