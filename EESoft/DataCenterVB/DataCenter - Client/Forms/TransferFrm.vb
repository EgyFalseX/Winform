    ...
    Private Sub BtnBrowse_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnBrowse.Click
        ...
        If OFD.ShowDialog = Windows.Forms.DialogResult.OK Then
            ...
            If CInt(FileInf.Length / 1048576) > 50 Then
                MsgBox_("«·„·› ÌÃ» «‰ ÌﬂÊ‰ «’€— „‰ 50 „ÌÃ«", 94, 23, False, Me)
            Else
    ...
    Public Sub ReciveFile(ByVal IP_Address As String, ByVal RPort As Int32, ByVal ServerFilePath As String, ByVal ClientFilePath As String)
        ...
        Try
            ...
            If Sok.Connected = True Then
                ...
                FileSTM.Close()
                LblBytes.Text = "0"
                MsgBox_(" „ «· Õ„Ì·", 109, 23, True, Me)
            Else
                MsgBox_("·„ ‰ „ﬂ‰ „‰ «·« ’«· »«·Œ«œ„", 105, 23, False, Me)
            End If
            Sok.Close()
            Sok = Nothing
                ...
                If Created = 1 Then
                    ...
                    Do
                        ...
                        If Created > 0 Then
                            ...
                            FrmTransfer.Text = "   «—”«· «·„·›  " & CInt((FrmTransfer.PBUpload.Value / FrmTransfer.PBUpload.Maximum) * 100) & " %"
                        Else
                            Exit Do
                        End If
                        Application.DoEvents()
                    Loop
                    FrmTransfer.Text = "ŒÌ«—«  „·› ÃœÌœ"
                    FrmTransfer.PBUpload.Value = 0
                    FrmTransfer.PBUpload.Maximum = 100
                    MsgBox_(" „ «·«—”«·", 121, 23, True, Me)
                Else : Sok.Close() : Sok = Nothing : MsgBox_(" „ —›÷ «·„·› „‰ ﬁ»· «·Œ«œ„", 51, 23, False, Me)
                End If
            End If
        Catch ex As Exception
            MsgBox_(ex.Message, 0, 23, False, Me)
