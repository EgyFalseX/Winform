    ...
    Private Sub TxtName_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtName.TextChanged
        ...
        For Int1 = 0 To sender.Text.Trim.Length - 1
            If Char.IsLetterOrDigit(sender.Text.Chars(Int1)) = False And sender.Text.Chars(Int1) <> "_" And sender.Text.Chars(Int1) <> " " Then
                ...
                MsgBox_("ãä ÝÖáß ÇÏÎá ÍÑæÝ æ ÇÑÞÇã", 98, 23, False, Me)
                Exit For
            End If
        Next
    End Sub
    Private Sub BtnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAdd.Click
        If MsgBox("åá ÇäÊ ãÊÃßÏ ?", MsgBoxStyle.YesNo, "WARNING") = MsgBoxResult.No Then
            Exit Sub
        End If
        ...
        If ErrorProvider = Nothing Then
            MsgBox_("Êã ÇÖÇÝÉ ÇáãÔÑæÚ", 74, 23, True, Me)
            Me.Close()
        Else
