Public Class PrivilegesFrm
    ...
    Private Sub BtnRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnRemove.Click
        If MsgBox("”Ì „ Õ–› Â–Â «·’·«ÕÌÂ" & vbNewLine & "Â· «‰  „ √ﬂœ?", MsgBoxStyle.YesNo) = MsgBoxResult.No Then
            Exit Sub
        End If
        ...
        If ResultErrors Is Nothing Then
            ...
            LblAction.Text = LBPrivileges.Items.Count
            MsgBox_(" „ «·Õ–›", 124, 23, True, Me)
        Else
            MsgBox_(ResultErrors & vbNewLine & "·„ Ì „ «·Õ–›", 0, 23, False, Me)
        End If
    End Sub
    ...
    Private Sub BtnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAdd.Click
        ...
        If ResultErrors Is Nothing = False Then
            ...
            LblAction.Text = LBPrivileges.Items.Count
            MsgBox_(" „ «·«÷«›Â", 117, 23, True, Me)
        Else
            'Cant insert
            MsgBox_("·„ Ì „ «·«÷«›Â", 128, 20, False, Me)
        End If
    End Sub
        ...
        If MsgBox("Â· «‰  „ √ﬂœ ?", MsgBoxStyle.YesNo, "WARNING") = MsgBoxResult.Yes Then
            ...
            If CBAllProjects.SelectedIndex <> -1 And LBPrivileges.SelectedIndex <> -1 And TxtUpdate.Text.Trim.Length > 0 Then
                ...
                If ResultErrors Is Nothing Then
                    ...
                    MsgBox_(" „ «· ⁄œÌ·", 97, 23, True, Me)
                Else
                    'cant update
                    MsgBox_("·„ Ì „ «· ⁄œÌ·", 82, 23, False, Me)
                End If
            End If
        End If
    End Sub
