...
namespace Members
{
    public partial class TBLMembersFastMaashatFrm : XtraForm
    {
        bool _Insert, _Update, _Delete;
        
        #region -   Functions   -
        public TBLMembersFastMaashatFrm()
        {
            InitializeComponent();
        }
        ...
        {
            LSMSMembers.QueryableSource = new DataSources.Linq.dsTeachersUnionViewsDataContext().vTBLMembersPlusShadetKeds;
            ActivePriv();
        }
        ...
        private void repositoryItemButtonEditSave_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            Members.DataSources.Linq.vTBLMembersPlusShadetKed member = (Members.DataSources.Linq.vTBLMembersPlusShadetKed)GV.GetRow(GV.GetFocusedDataSourceRowIndex());
        ...
        private void repositoryItemButtonEditPrint_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            GridView GV = (GridView)gridControlData.MainView;
            Members.DataSources.Linq.vTBLMembersPlusShadetKed member = (Members.DataSources.Linq.vTBLMembersPlusShadetKed)GV.GetRow(GV.GetFocusedDataSourceRowIndex());
            XRep10 FrmRep = new XRep10(member);
        ...
        {
            TBLMembersFastMaashatWFrm frm;
            if (DetailsTabFocus)
                frm = new TBLMembersFastMaashatWFrm(row, _Insert, _Update, _Delete, true);
            else
                frm = new TBLMembersFastMaashatWFrm(row, _Insert, _Update, _Delete, false);
