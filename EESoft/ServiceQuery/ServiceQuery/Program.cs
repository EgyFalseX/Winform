...
namespace ServiceQuery
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (FXFW.SqlDB.LoadSqlDBPath("ServiceQuery") /*&& Authentication()*/)
            {
                FXFW.SqlDB.LoadSQLReports();
                Logger = new FXFW.Logger(FXFW.Logger.LanguageInfo.English, Application.ProductName, ServiceQuery.Properties.Resources.EESoft, false);
                try
                {
