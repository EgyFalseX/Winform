...
{
    public partial class XRep02c : DevExpress.XtraReports.UI.XtraReport
    {
        int counter = 0;
        public XRep02c()
        {
        ...
        private void XRep01_ParametersRequestSubmit(object sender, DevExpress.XtraReports.Parameters.ParametersRequestEventArgs e)
        {
            ...
            rep02TableAdapter.FillBySyndicateId(dsReports.Rep02, DofatSarfId, SyndicateId, false);
            if (dsReports.Rep02.Rows.Count > 0)
            {
                xlFrom.Text = dsReports.Rep02[0].sarfdatefrom.ToString("yyyy-M-d");
                xlTo.Text = dsReports.Rep02[0].sarfdateto.ToString("yyyy-M-d");
            }
