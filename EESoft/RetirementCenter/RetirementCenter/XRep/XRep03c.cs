...
{
    public partial class XRep03c : DevExpress.XtraReports.UI.XtraReport
    {
        int counter = 0;
        public XRep03c()
        {
        ...
        private void XRep01_ParametersRequestSubmit(object sender, DevExpress.XtraReports.Parameters.ParametersRequestEventArgs e)
        {
            ...
            rep03TableAdapter.FillBySyndicateId(dsReports.Rep03, DofatSarfId, false, SyndicateId);
            if (dsReports.Rep03.Rows.Count > 0)
            {
                xlFrom.Text = dsReports.Rep03[0].sarfdatefrom.ToString("yyyy-M-d");
                xlTo.Text = dsReports.Rep03[0].sarfdateto.ToString("yyyy-M-d");
            }
