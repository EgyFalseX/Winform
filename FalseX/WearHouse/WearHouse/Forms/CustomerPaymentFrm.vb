Public Class CustomerPaymentFrm
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        If Val(TxtCount.Text.Trim) > 0 Then
            Insertion_Updateing_Deleting("INSERT INTO CusPays (CusID, CusDate, Amount) VALUES ('" & CBCus.SelectedValue.ToString & "',#" & DTP.Value.ToShortDateString & "#," & Val(TxtCount.Text.Trim) & ")")
