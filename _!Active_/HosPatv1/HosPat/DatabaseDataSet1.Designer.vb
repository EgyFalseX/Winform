...
Namespace DatabaseDataSet1TableAdapters
    ...
    Partial Public Class JobsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Jobs` WHERE ((`JobID` = ?) AND ((? = 1 AND `JobName` IS NULL) OR (`J"& _ 
                "obName` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Jobs` (`JobName`) VALUES (?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Jobs` SET `JobName` = ? WHERE ((`JobID` = ?) AND ((? = 1 AND `JobName` IS"& _ 
                " NULL) OR (`JobName` = ?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT JobID, JobName FROM Jobs"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DatabaseDataSet1.JobsDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DatabaseDataSet1.JobsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DatabaseDataSet1.JobsDataTable = New DatabaseDataSet1.JobsDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DatabaseDataSet1.JobsDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_JobID As Integer, ByVal Original_JobName As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal JobName As String, ByVal Original_JobID As Integer, ByVal Original_JobName As String) As Integer
            If (JobName Is Nothing) Then
