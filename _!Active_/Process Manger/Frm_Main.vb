...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ListView1.Size = New System.Drawing.Size(776, 228)
        ...
        Me.exitprogram.Font = New System.Drawing.Font("Microsoft Sans Serif", 14.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(178, Byte))
        ...
        Me.BtnToTray.Font = New System.Drawing.Font("Microsoft Sans Serif", 14.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(178, Byte))
        ...
        Me.ClientSize = New System.Drawing.Size(776, 327)
...
#End Region
    ...
    Private Sub refresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RefreshList.Click
        GetAllProcess()
    End Sub
    Private Sub Frm_Main_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseDown, ListView1.MouseDown, Panel1.MouseDown, programtitle.MouseDown, totalmem.MouseDown, totallabel.MouseDown
        x = e.X
        y = e.Y
        fla = True
    End Sub
    Private Sub Frm_Main_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseUp, ListView1.MouseUp, Panel1.MouseUp, programtitle.MouseUp, totalmem.MouseUp, totallabel.MouseUp
        fla = False
    End Sub
    Private Sub Frm_Main_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseMove, ListView1.MouseMove, Panel1.MouseMove, programtitle.MouseMove, totalmem.MouseMove, totallabel.MouseMove
        If fla = True Then
    ...
    Public Sub LoadFromFile(ByRef LV As ListView)
        ...
        Do Until Load.EndOfStream = True
            LV.Items.Add(Load.ReadLine).SubItems.Add("Dynamic")
        Loop
        Load.Close()
    End Sub
