...
#Region "Form Auto Move Subroutains"
    Public x As Int16
    Public y As Int16
    Public fla As Boolean
    Private Sub MSGBOXFrm_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseDown, BigPnl.MouseDown
        x = e.X
        y = e.Y
        fla = True
    End Sub
    Private Sub MSGBOXFrm_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseUp, BigPnl.MouseUp
        fla = False
    End Sub
    Private Sub MSGBOXFrm_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseMove, BigPnl.MouseMove
        If fla = True Then
